...
<div class="form-group">
  ...
  <div class="form-group">
	...
	<div class="form-group">
	      <label class="col-sm-3 control-label no-padding-right" for="form-field-1">新闻导读</label>
	...
	<div class="form-group">
	      <label class="col-sm-3 control-label no-padding-right" for="form-field-1">新闻作者</label>
		...
		else
		{
		 ...
		 let formData = new FormData();
	        ...
	        httpHelper({
	            ...
	            async:'TRUE',
	            data:formData,
	            url:"{{route('a_news_add')}}",
	            success:function(data){
	            	 let json_data = JSON.parse(data);
	            	 if(json_data.bool == true){
	            		 alert(json_data.message);
		            	 self.location="{{route('a_news_list')}}";
	            	 }else{
	            		 alert(json_data.message);
		            	 self.location="{{route('a_news_add')}}";
	            	 }
	            },
	            error:function(){
